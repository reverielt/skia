...
public:
 ...
 #ifdef REVERIE
   // reverie add
   uint16_t * charsToGlyphIDs(SkUnichar *uni,uint32_t no_of_chars,uint32_t * no_of_glyphs);
   // reverie add
   ...
   uint16_t *charsToSylEnds(SkUnichar *uni,uint32_t no_of_chars,uint32_t * no_of_sylends);
